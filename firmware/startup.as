	...
	; Compiler options:
	;
	; -oPIC16F877A.cof -mPIC16F877A.map --summary=default --output=default \
	; main.p1 usart.p1 adc.p1 timers.p1 lcd.p1 i2c.p1 eeprom.p1 pwm.p1 \
	; spi.p1 --chip=16F877A -P --runtime=default --opt=default -N-1 \
