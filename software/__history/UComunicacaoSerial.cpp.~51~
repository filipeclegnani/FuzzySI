...
void __fastcall TAutoNormalization::AtivaClick(TObject *Sender)
{
...
void __fastcall TAutoNormalization::ResClick(TObject *Sender)
{
...
void __fastcall TAutoNormalization::SetClick(TObject *Sender)
{
...
void __fastcall TAutoNormalization::FreioClick(TObject *Sender)
{
